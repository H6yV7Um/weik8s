...
need_default_key = {
    ...
    "model.id" : "{job_key}",
    "model.url": "http://10.77.29.69:8080/waic/models/register?algorithm=LDA&business=waic",
    "angel.ps.log.level" : "DEBUG",
    "angel.worker.log.level" : "DEBUG",
    "angel.am.log.level" : "DEBUG"
}
...
def lda_gen_submit_command_by_dict(_parameter_dict = {}, _job_key = ""):
    ...
    if(not _parameter_dict.has_key("sample.id")):
        ...
        center_user_name = get_args.get_value("result.json.center_user_name", _parameter_dict),
